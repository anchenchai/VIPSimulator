...
# Command lines arguments are:
 # Platform files:  platform_workflow-1ZGvD5_x_x_lim.xml
 # Deployment file: deployment_workflow-1ZGvD5_2.xml
...
for i in {1..1}
    do
      ...
      do
        ...
        run=$cmd" ${platform_file} simgrid_files/deployment_workflow-1ZGvD5_2.xml 100 100 300 1 0 0 ${version} 10000000 ${catalog} ${algo} 0 ${verbose} ${flag}"
        echo -e "\\t\\t$run"
